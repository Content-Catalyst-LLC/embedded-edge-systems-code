...
yaml_files = (
    list(root.glob("config/*.yml")) +
    list(root.glob("config/*.yaml")) +
    list(root.glob("gateway/*.yml")) +
    list(root.glob("edge_runtime/*.yml")) +
    list(root.glob("cloud_control_plane/*.yml")) +
    list(root.glob("model_lifecycle/*.yml")) +
    list(root.glob("security/*.yml"))
)
