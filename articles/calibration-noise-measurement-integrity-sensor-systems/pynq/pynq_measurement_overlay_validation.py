...
required = {"adc_sample_stream", "timestamp_counter", "saturation_flag", "quality_frame", "settling_window_valid"}
...
def main():
    ...
    print("Measurement overlay validation passed:", not issues)
    for issue in issues:
        print("-", issue)
